@extends('layout.app')
@section('title', 'Fees Transaction')
@section('content')
<div class="page-header card">
    <div class="card-block">
        ...
        <h5 class="m-b-10">Academin Fees Management</h5>
        <hr>
        <div  class="row">
            <div class="col-lg-12 col-xl-12s">
                ...
                <div class="tab-content card-block">
                    <div class="tab-pane @if(isset($data)){{''}} @else {{'active'}} @endif" id="markEntry" role="tabpanel">
                        <form id="billGenarator">
                            ...
                            {{--<div class="form-group has-success row">--}}
                                ...
                                {{--</div>--}}
                                {{--<div class="col-sm-10">--}}
                                    {{--<select id="endMonth" name="endMonth" class="form-control form-control-success">--}}
                                        {{--<option value="">Select Month</option>--}}
                                        {{--<option value="1">January</option>--}}
                                        {{--<option value="2">February</option>--}}
                                        {{--<option value="3">March</option>--}}
                    ...
                    <div class="tab-pane @if(isset($data)){{'active'}} @else {{''}} @endif" id="feeslog" role="tabpanel">
                        ...
                        {{ Form::open(array('url' => 'api/searchTransaction')) }}
