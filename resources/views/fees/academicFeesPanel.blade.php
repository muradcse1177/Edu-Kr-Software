...
<div class="page-header card">
    <div class="card-block">
        ...
        <h5 class="m-b-10">Academic Fees Management</h5>
        <hr>
        <div class="row">
...
@section('footer')
    ...
    <script>
        ...
        $('#selectYear').on('change', function() {
             ...
             var year= this.value ;
            var fullJson = "{\"classId\": \"" +classId+ "\", \"year\": \"" + year + "\"}";
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for(var i=0; i<data.length; i++)
                    {
                        ...
                        //selectBody += '<option value=\"' + data[i]['month'] + '\">'+ data[i]['month'] + '</option>';
        ...
        function showFeesList(feesTimeId) {
            ...
            window.location.href = "/api/showFeesList?feesTimeId="+fullJson;
        }
        ...
        $(document).ready(function(){
            ...
            $("#formAddSliderImage").validate({
                ...
                submitHandler: function(form) {
                    ...
                    var fullJson = "{\"year\": \"" +year+ "\", \"month\": \"" +month+ "\", \"fees\": " + data + "}";
                    //console.log(fullJson);
