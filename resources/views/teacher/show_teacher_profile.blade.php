    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header ">
                ...
                <center><h4>Employee Profile Management</h4></center><hr>
            </div>
            <div class="card-block">
                <form id="formEmployeeInfo">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <button id="submitClassInfo" class="form-control form-bg-primary">Search Info</button>
                        </div>
                    </div>
                </form>
            </div>
            <div class="card-block">
                <hr><center><h4>Employee Profile List</h4></center><hr>
                <div class="dt-responsive table-responsive">
                    <table id="tableemployeelist" class="table table-striped table-bordered nowrap">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Employee Dailts Information</h4>
                                ...
                                <div class="modal-body">
                                    <div>
                                        <p>Employee Information given below.If details Please download the full profile.</p>
                                        <ul id="modaluserInfo">
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function (){
            ...
            $("#formEmployeeInfo").validate({
                submitHandler: function(form) {
                    $.ajax({
                        url: '/api/showEmployeeList',
                        type: 'POST',
                        data: new FormData($("#formEmployeeInfo")[0]),
                        dataType:'json',
                        async:false,
                        processData: false,
                        contentType: false,
                        success: function (response) {
                            ...
                            length = data.length;
                            if(!$.trim(data)){
                                $('#tableemployeelist').html("No data found.Please try again.");
                            }
                            else{
                                var tbody= "<thead> " +
                                    "<tr> " +
                                ...
                                for(var i=0; i<data.length; i++)
                                {
                                    ...
                                    tbody += "<td>"+data[i]['employeeType']+"</td>";
                                    tbody += "<td>"+data[i]['designation']+"</td>";
                                    tbody += "<td>"+data[i]['dateOfJoining']+"</td>";
                                    tbody += "<td>"+data[i]['mobile']+"</td>";
                                    tbody += "<td>"+data[i]['nationality']+"</td>";
                                    tbody += "<td>"+data[i]['religion']+"</td>";
                                    tbody += "<td>"+data[i]['bloodGroup']+"</td>";
                                    tbody += "</tr>";
                                }
                                $('#tableemployeelist').html(tbody);
                            }
                        }
                    });
                    return false;
        ...
        function userInfo(i) {
            ...
            LiADD+='<li><strong>Employee ID:</strong>'+ data[i]['employeeId'] +'</li>';
            LiADD+='<li><strong>Mobile:</strong>'+  data[i]['mobile']+'</li>';
            LiADD+='<li><strong>Employee Type:</strong> '+ data[i]['employeeType'] +'</li>';
            LiADD+='<li><strong>Designation:</strong>'+ data[i]['designation'] +'</li>';
            LiADD+='<li><strong>Email:</strong>'+ data[i]['email'] +'</li>';
            LiADD+='<li><strong>Blood Group:</strong>'+  data[i]['bloodGroup']+'</li>';
