<div id="layerslider">
    <?php
                ...
                include 'db_conn.php';
                $sql = "SELECT * FROM web_slide_img where status='Active' order by id desc limit 10";
                ...
                <div class="ls-slide" data-ls="transition2d:104;timeshift:-2000;">
                    ...
                    <!-- Parallax Image -->
                    <img src="schoolWEB/img/sun.png" class="ls-l img-responsive hidden-xs hidden-sm parallax1" alt="" data-ls="delayin:1000;easingin:fadeIn;parallaxlevel:7;">
                    <!-- Text -->
                    ...
                    <!-- Parallax Image -->
                    <img src="schoolWEB/img/flower.png" class="ls-l img-responsive hidden-xs hidden-sm parallax2" alt="" data-ls="delayin:1500;easingin:fadeIn;parallaxlevel:6;">
                </div>
                <?php
            }
        }
