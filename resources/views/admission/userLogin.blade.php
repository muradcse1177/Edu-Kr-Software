        ...
        <div class="wrap-login100">
            <div class="login100-form-title" style="background-image: url(/loginResource/images/bg-01.jpg);">
					<span class="login100-form-title-1">
                        @if(isset($data['errorMessege']))
                            {{ $data['errorMessege'] }}
                        @endif
					</span>
            </div>

            {{ Form::open(array('url' => 'api/applicantLogin', 'method' => 'post', 'class'=>'login100-form validate-form')) }}

            <div class="wrap-input100 validate-input m-b-26" data-validate="Registration No. is required">
                <span class="label-input100">Registration No</span>
                <input class="input100" type="text" name="regNo" placeholder="Enter Registration No." required>
            ...
            <div class="wrap-input100 validate-input m-b-18" data-validate = "Mobile No is required">
                ...
                <input class="input100" type="mobile" name="mobile" placeholder="Enter Mobile No" required>
                <span class="focus-input100"></span>
            </div>
