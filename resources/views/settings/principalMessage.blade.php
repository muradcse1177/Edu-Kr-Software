    ...
    <div class="page-header card">
        <div class="card-block">
            <div class="card-header ">
                ...
                <h5 class="m-b-10">Principal Message Management</h5>
                <hr>
                <div class="row">
                            ...
                            <div class="tab-pane active" id="feeslog" role="tabpanel">
                                <form id="formAddSliderImage">
                                    <div class="form-group has-success row">
                                        <div class="col-sm-2">
                                            <label class="col-form-label" for="inputSuccess1">Principal Name</label>
                                        </div>
                                        <div class="col-sm-10">
                                            <input type="text" id="sliderNmae" name="sliderNmae" class="form-control " placeholder="Principal Name" >
                                        </div>
                                    </div>
                                    <div class="form-group has-success row">
                                        <div class="col-sm-2">
                                            <label class="col-form-label" for="inputSuccess1">Principal Image</label>
                                        </div>
                                        <div class="col-sm-10">
                                            <input type="file" id="image" name="image" class="form-control " placeholder="Principal Image" >
                                        </div>
                                    </div>
                                    <div class="form-group has-success row">
                                        <div class="col-sm-2">
                                            <label class="col-form-label" for="inputSuccess1">Message</label>
                                        </div>
                                        <div class="col-sm-10">
                                ...
                                <hr>
                                <center> <h4>Message List</h4></center>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for(var i=0; i<data.length; i++)
                    {
                        tbody += "<tr>";
                        tbody += "<td>"+ (i+1) +"</td>";
                        tbody += "<td>"+data[i]['principalName']+"</td>";
                        tbody += '<td><img height=\"40px\" width=\"60px\" src=\"'+data[i]['photo']+'\"></td>';
                        tbody += "<td>"+data[i]['message']+"</td>";
        ...
        $(document).ready(function(){
            ...
            $("#formEditSlideImg").validate({
                ...
                messages: {
                    sliderNmae: "Please give Principal Name",
                    image: "Please give Principal Image"
                },
                submitHandler: function(form) {
                    $.ajax({
                        url: '/api/editMessage',
        ...
        function editDesig(i) {
            ...
            document.getElementById('editsliderName').value = data[i]['principalName'];
            document.getElementById('editDescription').value = data[i]['message'];
