    ...
    <div class="page-header card">
        <div class="card-block">
            <div class="card-header ">
                ...
                <h5 class="m-b-10">Teacher Info Management</h5>
                <hr>
                <div class="row">
                    <div class="col-lg-12 col-xl-12s">
                        <ul class="nav nav-tabs md-tabs " role="tablist">
                            <li class="nav-item ">
                                <a class="nav-link active" data-toggle="tab" href="#feeslog" role="tab"><i class="icofont icofont-ui-message"></i>Add New Teacher Info</a>
                                <div class="slide"></div>
                            </li>
                            ...
                            <div class="tab-pane active" id="feeslog" role="tabpanel">
                                <form id="formAddSliderImage">
                                    ...
                                    <div class="form-group has-success row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="designation" name="designation" class="form-control " placeholder="Teacher Designation" >
                                        </div>
                                    </div>
                                    <div class="form-group has-success row">
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" id="image" name="image" class="form-control " placeholder="Teacher Photo" >
                                        </div>
                                    </div>
                                    <div class="form-group has-success row">
                                        <div class="col-sm-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <button type="submit" id="submitClassInfo" class="form-control form-bg-primary">Add Teacher Info</button>
                                        </div><hr>
                                    </div>
                                </form>
                                <hr>
                                <center> <h4>Teacher List</h4></center>
