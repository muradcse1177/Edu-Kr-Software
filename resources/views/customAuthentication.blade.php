                ...
                <div class="w3-container ">
                    <div class="w3-section">
                        ...
                        <form action="/login" method="POST">
                            ...
                            <input name="userId" class="w3-input w3-border w3-margin-bottom" type="text" placeholder="Enter User Id" required>
                            <label><b>Password</b></label>
                            <input class="w3-input w3-border w3-margin-bottom" name="password" type="password" placeholder="Enter Password" required>
                            <input type="submit" class="w3-btn w3-btn-block w3-green" value="Login">
            ...
            <div class="w3-container">
                <div class="w3-section">
                    ...
                    <form action="/register" method="POST" id="regForm">
                        ...
                        <input class="w3-input w3-border w3-margin-bottom" type="text"  name="userId" placeholder="Enter User Id" required value="{{ old('userId') }}">
                        <input class="w3-input w3-border w3-margin-bottom" type="text"  name="name" placeholder="Enter Name" required value="{{ old('name') }}">
                        <input class="w3-input w3-border w3-margin-bottom" type="text" name="email" placeholder="Enter Email" value="{{ old('email') }}" required>
                        <input class="w3-input w3-border w3-margin-bottom" type="password" name="password" required placeholder="Enter Password">
                        <input class="w3-input w3-border w3-margin-bottom" required type="password" name="password_confirmation" placeholder="Confirm Password">
