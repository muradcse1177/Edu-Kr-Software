    ...
    <div class="page-header card">
        <div class="card-block">
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Teacher Code</label>
                <div class="col-sm-10">
                    <input  type="text" class="form-control" name="name" id="name" placeholder="Text Input Teacher Code" required>
